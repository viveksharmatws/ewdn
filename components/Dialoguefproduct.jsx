      ...
      <div className="max-w-[330] w-full flex">
        <div className="w-1/2 ">
          <div className="p-[15px]">
            ...
            <Carousel
              ...
              className="py-[10px]"
            >
              <div className=" relative mx-1 w-full max-w-[330px]">
                <Image
                  src="/images/g3.jpg"
        ...
        <div className="w-1/2  overflow-auto p-[15px]">
          ...
          <div className="mt-[15px] flex gap-5">
            <div classNImageame="flex items-center justify-center gap-2">
          ...
          <div className="mt-[20px]">
            <span className="border-2 border-[#4cbb6c] bg-[#e9f9ee] px-[7px] py-[3px]  text-[14px] font-medium capitalize leading-[15px] tracking-[0.5px] text-[#4cbb6c] duration-300 group-hover:translate-x-3 ">
              In Stock
            </span>
          </div>
        </div>
